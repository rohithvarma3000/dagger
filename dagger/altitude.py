...
class Altitude:
    ...
    def get(self): #function for requesting the out packet
        ...
        try:
            ...
            altitude=struct.unpack('<i',self._connection.recv(4))[0] #signed int of 4 bytes hence i
            vario=struct.unpack('<h',self._connection.recv(2))[0] #signed int of 2 bytes hence h
